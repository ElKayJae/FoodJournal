...
public class Queries {
    ...
    public static final String SQL_REGISTER_USER = "insert into users(user_id, name, email, password, role) values (?,?,?,?,?)";
    public static final String SQL_INSERT_NEW_DAY = "insert into days(day_id, day, calories, user_id) values (?,?,?,?)";
    public static final String SQL_FIND_DAYS_BY_EMAIL = "select day_id, day, calories from days join users on days.user_id = users.user_id where users.email=?";
